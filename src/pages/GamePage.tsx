...
const GamePage: React.FC = () => {
  ...
  const handleSelectMode = (path: string) => {
    // Just navigate to the game mode - don't call selectMode as it resets progress
    navigate(path);
  };
    ...
    <PageTransition>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          >
            Each mode features different challenges to test and improve your
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              ...
              <li>
                You need to correctly answer at least 2 out of 3 questions to
                advance
              </li>
              <li>
                Correct answers earn you virtual money, while wrong answers cost
                you
              </li>
